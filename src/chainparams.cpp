...
{
    const char* pszTimestamp = "NY Times 06/Aug/2021 'Evangelion' Director Explains How He Finally Found His Ending";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1638166900, 2084536430, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x272282cfa8b8fc214307412f36db8921013d3aa2ec28fd2e1eb6bbf21b03970f"));
        assert(genesis.hashMerkleRoot == uint256S("0xb8c2a0ce108cc50ff3f54e3f8a9636c03669c5ecea5c49863a0aa7aa0214ce88"));
        ...
        checkpointData = (CCheckpointData) {
            {
                {  0, uint256S("0x272282cfa8b8fc214307412f36db8921013d3aa2ec28fd2e1eb6bbf21b03970f")},
            }
        };

        chainTxData = ChainTxData{
            // Data as of block 59c9b9d3fec105bdc716d84caa7579503d5b05b73618d0bf2d5fa639f780a011 (height 1353397).
            1638166900, // * UNIX timestamp of last known number of transactions
